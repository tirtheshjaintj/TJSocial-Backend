...
exports.likePost = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingLike = yield like_model_1.default.findOne({ post_id, user_id });
    if (existingLike) {
        yield like_model_1.default.deleteOne({ _id: existingLike._id });
        res.json({ status: true, message: "Unliked the post", data: false });
    }
    else {
        yield like_model_1.default.create({ post_id, user_id });
